...
public class Playlist
{
	...
	// Add a song/audiobook/podcast to the playlist
	public void addContent(AudioContent content)
	{
		contents.add(content);
	}

	// Find what songs/audiobooks/podcasts are in a playlist
	public ArrayList<AudioContent> getContent()
	{
		return contents;
	}

	// Find how much songs/audiobooks/podcasts are in a playlist
	public int getContentSize(){ return contents.size(); }
	...
	public boolean equals(Object other)
	{
		...
		return title.equals(otherCon.title);
	}
