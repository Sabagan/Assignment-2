...
abstract public class AudioContent
{
	...
	// Holds all information about the AudioContent
	// We stored letters as Capitals so we can use Contains with a IgnoresCaseCondition
	public String getInfo()
	{
		String info = title + "\t" + year + "\t" + id + "\t" + type + "\t" + length + "\t";
